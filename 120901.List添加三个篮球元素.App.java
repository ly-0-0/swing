...
public class App {
    ...
    List<JLabel> label_list=new ArrayList<>();//List方法
    //构造方法
    public App() {
    ...
    void go(){
        ...
        JFrame frame = new JFrame("哈哈哈哈");
        frame.setContentPane(myPanel);
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setBounds(100,100,1024,720);//整体画布的大小
        //frame.pack();
